<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link href="{{ route('customer.index') }}" wire:navigate
                                :active="request()->routeIs('customer.index')">

                        {{ __('Customers') }}
                    </x-nav-link>
                    <x-nav-link href="{{ route('service.index') }}" wire:navigate
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link href="{{ route('customer.index') }}" wire:navigate
                                   :active="request()->routeIs('customer.index')">
                {{ __('Customers') }}
            </x-responsive-nav-link>

            <x-responsive-nav-link href="{{ route('service.index') }}" wire:navigate
                                   :active="request()->routeIs('service.index')">
